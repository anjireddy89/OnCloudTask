...
import com.veeranji.memberService.service.exception.FavMovieNotFoundExpection;
import com.veeranji.memberService.service.impl.MemberService;
...
public class MemberController {
	...
	public List<Movie> getFavoriteMovies(@PathVariable(value = "id") String memberId) throws FavMovieNotFoundExpection {
	...
	public Movie addNewMember(@RequestBody Movie movie) {
